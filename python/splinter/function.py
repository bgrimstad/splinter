...
class Function:
    ...
    def getNumVariables(self):
        return splinter._call(splinter._getHandle().function_get_num_variables, self._handle)

    def save(self, fileName):
        splinter._call(splinter._getHandle().function_save, self._handle, getCString(fileName))

    def __del__(self):
        if self._handle is not None:
            splinter._call(splinter._getHandle().function_delete, self._handle)
        self._handle = None
